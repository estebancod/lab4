...
<body>
    ...
    <div class="button-container">
        <button onclick="window.location.href='cardiologia.php'">CARDIOLOGIA</button>
        <button onclick="window.location.href='neurologia.html'">NEUROLOGIA</button>
        <button onclick="window.location.href='odontologia.html'">ODONTOLOGIA</button>
        <button onclick="window.location.href='dermatologia.html'">DERMATOLOGIA</button>
        <button onclick="window.location.href='pediatria.php'">PEDIATRIA</button>
    </div>
</body>
</html>
